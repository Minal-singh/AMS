...
urlpatterns = [
    ...
    #face_recognition
    path("admin/create-dataset/",face_recognition_views.create_dataset,name="create_dataset"),
    path("admin/create-dataset/<str:id>/",face_recognition_views.create_dataset_for_student,name="create_dataset_for_student"),
    path("admin/train-model/",face_recognition_views.train_model,name="train_model"),
    path("admin/mark-attendance/",face_recognition_views.mark_attendance,name="mark_attendance"),
